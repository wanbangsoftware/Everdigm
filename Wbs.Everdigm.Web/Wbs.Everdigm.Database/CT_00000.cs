...
namespace Wbs.Everdigm.Database
{
    ...
    public partial class CT_00000 : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// 命令的数据内容：
        /// <para>0=汉字1=ASCII字符(一般发给用户)2=16进制数据(一般发给终端)</para>
        /// <para>3：以数字表示的超速设置，单位km/h；4：以数字表示的越界设置（半径，经度，纬度））；</para>
        /// <para>5：3和4的结合（排列方式：超速设置，半径，经度，纬度）。</para>
        /// </summary>
        ...
        /// <summary>
        /// 命令的发送状态
        /// 参见<see cref="CommandStatus"/>中各个定义
        /// </summary>
