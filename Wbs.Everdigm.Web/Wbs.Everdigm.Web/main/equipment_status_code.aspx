<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="equipment_status_code.aspx.cs" Inherits="Wbs.Everdigm.Web.main.equipment_status_code" %>
        ...
        <div id="main-content">
            ...
            <div class="content-box">
                <div class="content-box-header">
                    <h3>System: Equipment - Situation Code</h3>
                    <div class="clear"></div>
                </div>
                    ...
                    <div class="tab-content default-tab" id="tab1">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #ccc; margin-top: 2px;">
                            ...
                            <tr>
                                ...
                                <td class="td_left">
                                    <asp:DropDownList ID="ddlType" runat="server" CssClass="text-input important-input"></asp:DropDownList>
                                </td>
                                <td class="td_right">&nbsp;</td>
                                <td class="td_left">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td class="td_left">
                                    <input type="text" runat="server" class="text-input important-input" id="txtCode" />
                                </td>
                                <td class="td_right">&nbsp;</td>
                                <td class="td_left">&nbsp;</td>
                            </tr>
                        ...
                        <table id="tbTable" width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #ccc; margin-top: 2px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 250px;">Situation</th>
                        ...
                        <p>
                            <b>Explanation</b>:<br />
                            <span style="color:#ff0000;">DO NOT CHANGE those CODE if you haven't a full grasp</span>
                        </p>
                    </div>
                </div>
            </div>
