<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="warehouse.aspx.cs" Inherits="Wbs.Everdigm.Web.main.warehouse" %>
        ...
        <div id="main-content">
            ...
            <div class="content-box">
                <div class="content-box-header">
                    <h3>System: Equipment - Warehouses</h3>
                    <div class="clear"></div>
                </div>
                    ...
                    <div class="tab-content default-tab" id="tab1">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #ccc; margin-top: 2px;">
                            ...
                            <tr>
                                ...
                                <td class="td_left">
                                    <input type="text" runat="server" class="text-input important-input" id="txtAbbreviation" /></td>
                                <td class="td_right">&nbsp;</td>
                                <td class="td_left">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td class="td_left">
                                    <input type="text" runat="server" class="text-input" id="txtAddress" />
                                </td>
                                <td class="td_right">&nbsp;</td>
                                <td class="td_left">&nbsp;</td>
                            </tr>
                        ...
                        <table id="tbTable" width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #ccc; margin-top: 2px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 180px;">Abbreviation Code</th>
                                    <th>Address</th>
                                </tr>
                            </thead>
                            <tfoot>
