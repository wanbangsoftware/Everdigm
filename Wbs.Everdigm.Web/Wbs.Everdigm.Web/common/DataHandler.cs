...
namespace Wbs.Everdigm.Web
{
    ...
    public partial class DataHandler
    {
        ...
        /// 处理旧链接的时间间隔
        /// </summary>
        public static int CLEAR_OLD_LINK_INTERVAL_MINUTES = 1;
        /// <summary>
        /// 最后一次清理旧链接的时间
        /// </summary>
        ...
        public bool CanClearOlderLinks
        {
            get
            {
                return DateTime.Now.AddMinutes(-CLEAR_OLD_LINK_INTERVAL_MINUTES) <= LastOlderLinkHandledTime;
            }
        }
            ...
            try
            {
                switch (data.DataType)
                {
                    ...
                    case AsyncUserDataType.ReceivedData:
                        ...
                        if (data.Buffer.Length < TX300Items.header_length)
                            return;
        ...
        /// <![CDATA[121]]>
        /// <returns></returns>
        public List<TB_Command> CheckCommand()
        {
            return CommandInstance.FindList(f => f.ScheduleTime >= DateTime.Now.AddSeconds(-30) &&
        ...
        public void UpdateCommand(TB_Command obj,CommandStatus status)
        {
        ...
        {
            // 如果还未到处理的时间则不处理
            if (LastOlderLinkHandledTime > DateTime.Now.AddMinutes(-CLEAR_OLD_LINK_INTERVAL_MINUTES)) { return; }
            LastOlderLinkHandledTime = DateTime.Now;
        ...
        private void HandleCommandResponsed(TX300 tx300)
        {
            CommandInstance.Update(f => f.DestinationNo == tx300.TerminalID && 
                ...
                f.ScheduleTime < DateTime.Now.AddMinutes(-2) &&
